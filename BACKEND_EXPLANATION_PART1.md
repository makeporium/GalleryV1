...
2. Click "Add Project"
3. Name it (e.g., "SnapShot-a1ff5" — this is our project ID)
4. Disable Google Analytics if you don't need it
5. Click "Create Project"

#### 3.2 Add an Android App to Firebase
1. In Firebase Console, click "Add app" → Android icon
2. Enter your **package name**: `com.example.snapshot`
...
```json
{
  "project_info": {
    ...
    "project_id": "SnapShot-a1ff5",            // The human-readable project ID you chose
    "storage_bucket": "SnapShot-a1ff5.firebasestorage.app"  // For file storage (not used here)
  },
  "client": [
    {
      "client_info": {
        ...
        "android_client_info": {
          "package_name": "com.example.snapshot"   // Must match your app's applicationId
        }
      },
      "oauth_client": [
        {
          ...
          "android_info": {
            "package_name": "com.example.snapshot",
